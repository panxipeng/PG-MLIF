...
# --ignore_missing_moltype 1 --ignore_missing_histype 0 --use_vgg_features 1 --roi_dir all_st_patches_512 --gpu_ids 0 --model_name path_3splits_10 --use_rnaseq 1
"""
all_st
...
python make_splits.py --ignore_missing_moltype 1 --ignore_missing_histype 0 --use_vgg_features 0 --roi_dir all_st --use_rnaseq 1 # for training Surv Omic, Surv Graphomic
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='path_2splits_15', help='mode')
...
pnas_splits = pd.read_csv('/home/yons/An/paper/20220318-PathomicFusion/20230529PO-Fusion/data/TCGA_GBMLGG/2splits_15.csv')
...
def getAlignedMultimodalData(opt, model, device, all_dataset, pat_split, pat2img):
    ...
    return x_patname, x_path,  x_omic, e, t, g
...
pickle.dump(data_dict, open('%s/splits/gbmlgg15cv_%s_%d_%d_%d%s_%s.pkl' % (opt.dataroot, opt.roi_dir, opt.ignore_missing_moltype, opt.ignore_missing_histype, opt.use_vgg_features, '_rnaseq' if opt.use_rnaseq else '','2splits_15'), 'wb'))
